...
fn main() {
    ...
    println!("{:0>32b}", 1000);
    println!("{}{:0>8b}", " ".repeat(32 - 8), 1000 as u8);
    // -1 + 256 = 255
    println!("  -1 as a u8 is: {}", (-1i8) as u8);
    println!("{:0>32b}", (-1i8));
    println!("{}{:0>8b}", " ".repeat(32 - 8), (-1i8) as u8);
    ...
    println!("{:0>32b}", 128);
    println!("{}{:0>16b}", " ".repeat(32 - 16), 128 as i16);
    // 128 转成 u8 还是 128，但转到 i8 相当于给 128 取八位的二进制补码，其值是：
    println!(" 128 as a u8 is: {}", 128 as u8);
    println!("{:0>32b}", 128);
    println!("{}{:0>8b}", " ".repeat(32 - 8), 128 as u8);
    println!(" 128 as a i8 is: {}", 128 as i8);
    println!("{:0>32b}", 128);
    println!("{}{:0>8b}", " ".repeat(32 - 8), 128 as i8);
    ...
    println!("{:0>32b}", 232);
    println!("{}{:0>8b}", " ".repeat(32 - 8), 232 as i8);
}
